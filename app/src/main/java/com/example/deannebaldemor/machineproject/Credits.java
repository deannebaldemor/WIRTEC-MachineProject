...
public class Credits extends Activity {
    ...
    public void createList(){
        Log.v("TAG","pumasok");
        Source s1 = new Source("https://tomcottrell.wordpress.com/2011/05/02/deception-island-dare/");
        sources.add(s1);
        Source s2 = new Source("http://johnsigrid.blogspot.com/2014/02/s-americaantarctica-12302013-danco-coast.html");
        sources.add(s2);
        ...
        sources.add(s55);
        Source s56 = new Source("https://www.educationaltravelfinder.com/");
        sources.add(s56);
        Source s57 = new Source("https://pixabay.com/en/photos/trevi%20fountain/");
        sources.add(s57);

        Source s58 = new Source("http://www.airpano.com/Photogallery-AirPano.php");
        sources.add(s58);
